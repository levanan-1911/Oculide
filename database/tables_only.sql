-- =============================================
-- Create Tables Only for ExamSystem Database
-- SQL Server Compatible
-- =============================================
-- Hướng dẫn:
-- 1. Tạo database "ExamSystem" thủ công trong SSMS (như ShopManager)
-- 2. Chọn database "ExamSystem" trong dropdown
-- 3. Chạy script này (F5 hoặc Execute)
-- =============================================
